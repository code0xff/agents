...
export const ko: Dict = {
  ...
  'sol.title': '솔라나',
  'sol.eyebrow': '표본, 전체 집계 아님',
  'sol.rate': '관측 속도',
  'sol.share': 'x402 결제 중 비중',
  'sol.cumulative': '누적 결제',
  'sol.services': '솔라나를 받는 서비스',
  'sol.note': '솔라나에는 x402를 체인 전체에서 걸러낼 방법이 없어, 이미 알고 있는 facilitator의 최근 서명만 표본으로 읽습니다. 전체가 아니라 하한값입니다.',
